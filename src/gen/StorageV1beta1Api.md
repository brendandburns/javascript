...
let body:.StorageV1beta1ApiCreateVolumeAttributesClassRequest = {
...
let body:.StorageV1beta1ApiDeleteCollectionVolumeAttributesClassRequest = {
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
let body:.StorageV1beta1ApiDeleteVolumeAttributesClassRequest = {
...
let body:.StorageV1beta1ApiListVolumeAttributesClassRequest = {
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
let body:.StorageV1beta1ApiPatchVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // any
  body: {},
...
let body:.StorageV1beta1ApiReadVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
let body:.StorageV1beta1ApiReplaceVolumeAttributesClassRequest = {
  // string | name of the VolumeAttributesClass
  name: "name_example",
  // V1beta1VolumeAttributesClass
  body: {
