...
> V1alpha1LeaseCandidate createNamespacedLeaseCandidate(body)
...
const apiInstance = new .CoordinationV1alpha1Api(configuration);

let body:.CoordinationV1alpha1ApiCreateNamespacedLeaseCandidateRequest = {
...
apiInstance.createNamespacedLeaseCandidate(body).then((data:any) => {
...
let body:.CoordinationV1alpha1ApiDeleteCollectionNamespacedLeaseCandidateRequest = {
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.deleteCollectionNamespacedLeaseCandidate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CoordinationV1alpha1ApiDeleteNamespacedLeaseCandidateRequest = {
  // string | name of the LeaseCandidate
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
...
apiInstance.deleteNamespacedLeaseCandidate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
let body:.CoordinationV1alpha1ApiListLeaseCandidateForAllNamespacesRequest = {
...
apiInstance.listLeaseCandidateForAllNamespaces(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> V1alpha1LeaseCandidateList listNamespacedLeaseCandidate()
...
let body:.CoordinationV1alpha1ApiListNamespacedLeaseCandidateRequest = {
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
  // string | If \'true\', then the output is pretty printed. Defaults to \'false\' unless the user-agent indicates a browser or command-line HTTP tool (curl and wget). (optional)
  pretty: "pretty_example",
...
apiInstance.listNamespacedLeaseCandidate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> V1alpha1LeaseCandidate patchNamespacedLeaseCandidate(body)
...
let body:.CoordinationV1alpha1ApiPatchNamespacedLeaseCandidateRequest = {
  // string | name of the LeaseCandidate
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
apiInstance.patchNamespacedLeaseCandidate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> V1alpha1LeaseCandidate readNamespacedLeaseCandidate()
...
let body:.CoordinationV1alpha1ApiReadNamespacedLeaseCandidateRequest = {
  // string | name of the LeaseCandidate
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
apiInstance.readNamespacedLeaseCandidate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
...
> V1alpha1LeaseCandidate replaceNamespacedLeaseCandidate(body)
...
let body:.CoordinationV1alpha1ApiReplaceNamespacedLeaseCandidateRequest = {
  // string | name of the LeaseCandidate
  name: "name_example",
  // string | object name and auth scope, such as for teams and projects
  namespace: "namespace_example",
...
apiInstance.replaceNamespacedLeaseCandidate(body).then((data:any) => {
  console.log('API called successfully. Returned data: ' + data);
}).catch((error:any) => console.error(error));
```
